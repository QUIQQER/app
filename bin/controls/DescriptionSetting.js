 ...
 * @require Ajax
 */
define('package/quiqqer/app/bin/controls/DescriptionSetting', [
    ...
    return new Class({
        ...
        Extends: QUIControl,
        Type: 'package/quiqqer/app/bin/controls/DescriptionSetting',
        ...
        $onImport: function () {
            ...
            QUIAjax.get([
                ...
                this.$Languages = new InputMultiLang({
                    ...
                    name: 'quiqqerApp.settings.description'
                }).inject(this.$Elm, 'after');

            }.bind(this), {
                'package': 'quiqqer/translator',
                'group': 'quiqqer/app',
                'var': 'app.description.' + this.$Project.getName()
            });
        }
    });
});